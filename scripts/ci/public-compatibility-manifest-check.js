...
const metadataPolicies = {
  ...
  rustSupportCrate: ['exact five-field object on an extern class; valid declarations stop before source admission and every other typed placement is rejected', 'absent'],
...
const definePolicyOverrides = {
  ...
  rust_forbid_unsafe: ['presence flag', 'disabled'],
...
function classifyNewType(name) {
  ...
  const exact = {
    ...
    'rust.process.CurrentProcess': 'rust-values-qualified',
    'rust.process.CurrentProcessError': 'rust-values-qualified',
