...
impl Output {
    pub fn write_byte(_self_: &std::cell::RefCell<Output>, _c: i32) {
    ...
    pub fn flush(_self_: &std::cell::RefCell<Output>) {}

    pub fn close(_self_: &std::cell::RefCell<Output>) {}

    pub fn set_big_endian(self_: &std::cell::RefCell<Output>, b: bool) -> bool {
        {
            let __tmp = b;
    ...
    pub fn write(self_: &std::cell::RefCell<Output>, s: crate::HxRef<hxrt::bytes::Bytes>) {
    ...
    pub fn write_float(self_: &std::cell::RefCell<Output>, x: f64) {
    ...
    pub fn write_double(self_: &std::cell::RefCell<Output>, x: f64) {
    ...
    pub fn write_int8(self_: &std::cell::RefCell<Output>, x: i32) {
        if x < -128 || x >= 128 {
    ...
    pub fn write_int16(self_: &std::cell::RefCell<Output>, x: i32) {
        if x < -32768 || x >= 32768 {
            hxrt::exception::throw(hxrt::dynamic::from(hxrt::io::Error::Overflow));
        }
    ...
    pub fn write_u_int16(self_: &std::cell::RefCell<Output>, x: i32) {
        if x < 0 || x >= 65536 {
            hxrt::exception::throw(hxrt::dynamic::from(hxrt::io::Error::Overflow));
        }
        if self_.borrow().big_endian {
    ...
    pub fn write_int24(self_: &std::cell::RefCell<Output>, x: i32) {
    ...
    pub fn write_u_int24(self_: &std::cell::RefCell<Output>, x: i32) {
        if x < 0 || x >= 16777216 {
            hxrt::exception::throw(hxrt::dynamic::from(hxrt::io::Error::Overflow));
        }
        if self_.borrow().big_endian {
    ...
    pub fn write_int32(self_: &std::cell::RefCell<Output>, x: i32) {
        if self_.borrow().big_endian {
    ...
    pub fn prepare(_self_: &std::cell::RefCell<Output>, _nbytes: i32) {}
...
impl crate::haxe_io_output::OutputTrait for std::cell::RefCell<Output> {
    fn __hx_get_big_endian(&self) -> bool {
