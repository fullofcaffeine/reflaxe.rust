...
pub(crate) fn __hx_is_subtype_type_id(actual: u32, expected: u32) -> bool {
    ...
    match actual {
        0xc9f41c03u32 => matches!(expected, 0x58b80944u32),
...
fn is_missing(value: crate::HxRc<dyn crate::i_thing::IThing + Send + Sync>) -> bool {
    return {
        let _ = value;
        false
    };
...
fn is_present(value: crate::HxRc<dyn crate::i_thing::IThing + Send + Sync>) -> bool {
    return {
        let _ = value;
        true
    };
...
fn main() {
    ...
    crate::sys::Sys::println(hxrt::dynamic::from(is_present(value.clone())));
}
