...
pub struct Socket {
    ...
    hostname: hxrt::string::HxString,
    server_cert: crate::HxRef<crate::sys_ssl_certificate::Certificate>,
    server_key: crate::HxRef<crate::sys_ssl_key::Key>,
    sni_matchers:
        hxrt::array::Array<crate::HxDynRef<dyn Fn(hxrt::string::HxString) -> bool + Send + Sync>>,
    sni_certs: hxrt::array::Array<crate::HxRef<crate::sys_ssl_certificate::Certificate>>,
    sni_keys: hxrt::array::Array<crate::HxRef<crate::sys_ssl_key::Key>>,
}
...
impl Socket {
    pub fn new() -> crate::HxRef<crate::sys_ssl_socket::Socket> {
        let self_: crate::HxRef<crate::sys_ssl_socket::Socket> = crate::HxRef::new(Socket {
            ...
            hostname: hxrt::string::HxString::null(),
            server_cert: crate::HxRef::<crate::sys_ssl_certificate::Certificate>::null(),
            server_key: crate::HxRef::<crate::sys_ssl_key::Key>::null(),
            sni_matchers: hxrt::array::Array::<
                crate::HxDynRef<dyn Fn(hxrt::string::HxString) -> bool + Send + Sync>,
            >::new(),
            sni_certs:
                hxrt::array::Array::<crate::HxRef<crate::sys_ssl_certificate::Certificate>>::new(),
            sni_keys: hxrt::array::Array::<crate::HxRef<crate::sys_ssl_key::Key>>::new(),
        });
        {
    ...
    pub fn handshake(self_: &crate::HxRefCell<Socket>) {
            ...
            .is_null()
        {
            ...
            .len() as i32)
                > 0
            {
                crate::socket_native::tls_handshake_server_sni(
                    &({
                        let __b = __hx_this.borrow();
                        __b.handle.clone()
                    }),
                    ...
                    {
                        let _g: hxrt::array::Array<crate::HxRef<hxrt::ssl::Certificate>> =
                            hxrt::array::Array::<crate::HxRef<hxrt::ssl::Certificate>>::new();
                        {
                            let _g2: hxrt::array::Array<
                                crate::HxRef<crate::sys_ssl_certificate::Certificate>,
                            > = {
                                let __b = __hx_this.borrow();
                                __b.sni_certs.clone()
                            };
                            for cert in _g2.iter_borrowed() {
                                _g.push(if cert.is_null() {
                                    crate::HxRef::<hxrt::ssl::Certificate>::null()
                                } else {
                                    let __b = cert.borrow();
                                    __b.handle.clone()
                                });
                    ...
                    {
                        let _g_2: hxrt::array::Array<crate::HxRef<hxrt::ssl::Key>> =
                            hxrt::array::Array::<crate::HxRef<hxrt::ssl::Key>>::new();
                        {
                            let _g2_2: hxrt::array::Array<crate::HxRef<crate::sys_ssl_key::Key>> = {
                                let __b = __hx_this.borrow();
                                __b.sni_keys.clone()
                            };
                            for key in _g2_2.iter_borrowed() {
                                _g_2.push(if key.is_null() {
                                    crate::HxRef::<hxrt::ssl::Key>::null()
                                } else {
                                    let __b = key.borrow();
                                    __b.handle.clone()
                                });
                ...
                crate::socket_native::tls_handshake_server(
                    &({
                        let __b = __hx_this.borrow();
                        __b.handle.clone()
                    }),
        ...
        crate::socket_native::tls_handshake_client(
            &({
                let __b = __hx_this.borrow();
                __b.handle.clone()
            }),
    ...
    pub fn set_hostname(self_: &crate::HxRefCell<Socket>, name: hxrt::string::HxString) {
        let __hx_this: crate::HxRef<crate::sys_ssl_socket::Socket> = self_.self_ref();
        {
            let __tmp = name;
            __hx_this.borrow_mut().hostname = hxrt::string::HxString::from(__tmp.clone());
            __tmp
        };
    }
    ...
    pub fn add_sni_certificate(
        self_: &crate::HxRefCell<Socket>,
        cb_servername_match: crate::HxDynRef<dyn Fn(hxrt::string::HxString) -> bool + Send + Sync>,
        cert: crate::HxRef<crate::sys_ssl_certificate::Certificate>,
        key: crate::HxRef<crate::sys_ssl_key::Key>,
    ) {
        let __hx_this: crate::HxRef<crate::sys_ssl_socket::Socket> = self_.self_ref();
    ...
    pub fn peer_certificate(
        ...
        let __hx_this: crate::HxRef<crate::sys_ssl_socket::Socket> = self_.self_ref();
        return crate::sys_ssl_certificate::Certificate::from_handle(
            crate::socket_native::tls_peer_certificate(
                &({
                    let __b = __hx_this.borrow();
                    __b.handle.clone()
                }),
