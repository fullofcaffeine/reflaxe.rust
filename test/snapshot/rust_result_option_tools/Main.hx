...
class Main {
	static function main() {
		...
		var n = o.map(function(v:Int):Int return v + 1).andThen(function(v:Int):Option<Int> return (v > 0 ? Some(v * 2) : None)).unwrapOr(0);
		...
		var r2 = r.mapOk(function(v:Int):Int return v + 5).andThen(function(v:Int):Result<Int, String> return (v > 100 ? Err("too big") : Ok(v)));

		var msg = r2.context("computing value").unwrapOrElse(function(_e:String):Int return -1);
		trace(msg);
