...
fn read_value(counter: crate::HxRef<crate::counter::Counter>) -> i32 {
    return {
...
fn main() {
    let counter: crate::HxRef<crate::counter::Counter> = crate::counter::Counter::new(7);
    println!("{}", hxrt::dynamic::from(read_value(counter.clone())));
}
