...
impl Json {
    ...
    pub fn stringify(
        ...
        if !replacer.is_null() {
            if !space.is_null() {
                return hxrt::string::HxString::from(hxrt::json::stringify_with_replacer_pretty(
                    value.clone(),
                    replacer.clone(),
                    &space,
                ));
        ...
        if !space.is_null() {
            return hxrt::string::HxString::from(hxrt::json::stringify_pretty(
                value.clone(),
                &space,
            ));
        }
        return hxrt::string::HxString::from(hxrt::json::stringify(value.clone()));
    }
