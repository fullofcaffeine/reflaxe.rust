...
fn main() {
    let down: i32 =
        hxrt::string::parse_float(hxrt::string::HxString::from("3.9").as_str()).floor() as i32;
    let negative: i32 =
        hxrt::string::parse_float(hxrt::string::HxString::from("-1.2").as_str()).floor() as i32;
    crate::sys::Sys::println(hxrt::dynamic::from(down));
    crate::sys::Sys::println(hxrt::dynamic::from(negative));
    crate::sys::Sys::println(hxrt::dynamic::from(down + negative));
}
