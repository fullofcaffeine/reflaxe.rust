...
impl SocketOutput {
    ...
    pub fn prepare(_self_: &crate::HxRefCell<SocketOutput>, _nbytes: i32) {}
    ...
    fn __hx_super_haxe_io_output_close(_self_: &crate::HxRefCell<SocketOutput>) {}
}

impl crate::haxe_io_output::OutputTrait for crate::HxRefCell<SocketOutput> {
    ...
    fn write_input(
        ...
        SocketOutput::write_input(self, i, bufsize)
    }
    fn write_int16(&self, x: i32) -> () {
        SocketOutput::write_int16(self, x)
    }
    fn write_int24(&self, x: i32) -> () {
        SocketOutput::write_int24(self, x)
    }
    fn write_int32(&self, x: i32) -> () {
        SocketOutput::write_int32(self, x)
    }
    ...
    fn write_u_int16(&self, x: i32) -> () {
        SocketOutput::write_u_int16(self, x)
    }
    fn write_u_int24(&self, x: i32) -> () {
        SocketOutput::write_u_int24(self, x)
    }
    fn __hx_type_id(&self) -> u32 {
        crate::sys_net_socket_output::__HX_TYPE_ID
    }
}
