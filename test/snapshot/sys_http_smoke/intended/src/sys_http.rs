...
impl Http {
    pub fn new(url: hxrt::string::HxString) -> crate::HxRef<crate::sys_http::Http> {
        ...
        });
        {
            ...
            let __hx_dyn_rc: crate::HxRc<dyn Fn(hxrt::string::HxString) + Send + Sync> =
                crate::HxRc::new(move |a0: hxrt::string::HxString| {
                    crate::sys_http::Http::__hx_dyn_default_on_data(&*__hx_dyn_recv_on_data, a0);
                });
        ...
        };
        {
            ...
            let __hx_dyn_rc: crate::HxRc<dyn Fn(crate::HxRef<hxrt::bytes::Bytes>) + Send + Sync> =
                crate::HxRc::new(move |a0: crate::HxRef<hxrt::bytes::Bytes>| {
                    crate::sys_http::Http::__hx_dyn_default_on_bytes(&*__hx_dyn_recv_on_bytes, a0);
                });
        ...
        };
        {
            ...
            let __hx_dyn_rc: crate::HxRc<dyn Fn(hxrt::string::HxString) + Send + Sync> =
                crate::HxRc::new(move |a0: hxrt::string::HxString| {
                    crate::sys_http::Http::__hx_dyn_default_on_error(&*__hx_dyn_recv_on_error, a0);
                });
        ...
        };
        {
            ...
            let __hx_dyn_rc: crate::HxRc<dyn Fn(i32) + Send + Sync> =
                crate::HxRc::new(move |a0: i32| {
                    crate::sys_http::Http::__hx_dyn_default_on_status(
    ...
    pub fn custom_request(
        ...
        ) == 0
        {
            crate::sys_http::Http::on_error(
                &*__hx_this,
                hxrt::string::HxString::from("Invalid URL"),
            );
            return;
        }
        ...
        .is_null();
        let mut boundary: hxrt::string::HxString = hxrt::string::HxString::null();
        ...
        if !method.is_null() {
            ...
            if post {
                crate::haxe_io_bytes_output::BytesOutput::write_string(
                    &*request_bytes,
                    hxrt::string::HxString::from("POST "),
                    None,
                );
            } else {
                crate::haxe_io_bytes_output::BytesOutput::write_string(
                    &*request_bytes,
                    hxrt::string::HxString::from("GET "),
                    None,
                );
            }
        }
        ...
        crate::haxe_io_bytes_output::BytesOutput::write_string(
            &*request_bytes,
            hxrt::string::HxString::from(format!("{}{}{}", " HTTP/1.1\r\nHost: ", &host, "\r\n")),
            None,
        );
        if !({
            let __b = __hx_this.borrow();
            ...
            if post && !uri.is_null() {
                if multipart
                    || !crate::sys_http::Http::has_header(
                        &*__hx_this,
                        hxrt::string::HxString::from("Content-Type"),
                    )
                {
                    crate::haxe_io_bytes_output::BytesOutput::write_string(
                        &*request_bytes,
                    ...
                    if multipart {
                        crate::haxe_io_bytes_output::BytesOutput::write_string(
                            &*request_bytes,
                            hxrt::string::HxString::from("multipart/form-data; boundary="),
                            None,
                        );
                        crate::haxe_io_bytes_output::BytesOutput::write_string(
                            &*request_bytes,
                        ...
                        crate::haxe_io_bytes_output::BytesOutput::write_string(
                            &*request_bytes,
                            hxrt::string::HxString::from("application/x-www-form-urlencoded"),
                            None,
                        );
                    }
                    crate::haxe_io_bytes_output::BytesOutput::write_string(
        ...
        crate::haxe_io_bytes_output::BytesOutput::write_string(
            &*request_bytes,
            hxrt::string::HxString::from("Connection: close\r\n"),
            None,
        );
        {
    ...
    fn build_params_string(self_: &crate::HxRefCell<Http>) -> hxrt::string::HxString {
            ...
            hxrt::array::Array::<hxrt::string::HxString>::new();
        {
            ...
            for p in _g1.iter_borrowed() {
                encoded.push(hxrt::string::HxString::from(format!(
                    "{}{}{}",
        ...
        return hxrt::string::HxString::from(encoded.join(hxrt::string::HxString::from("&")));
    }
    ...
    fn create_boundary(_self_: &crate::HxRefCell<Http>) -> hxrt::string::HxString {
        return hxrt::string::HxString::from("---------------------------reflaxe-rust-boundary");
    }
    ...
    fn perform_request(
        ...
        match hxrt::exception::catch_unwind(|| {
            ...
            Err(__hx_ex) => {
                ...
                crate::sys_http::Http::on_error(
                    &*__hx_this,
                    hxrt::string::HxString::from(e.to_haxe_string()),
                );
            }
        };
    }
    ...
    fn write_multipart_tail(
        ...
        sock.__hx_get_output()
            .write_string(hxrt::string::HxString::from("\r\n"), None);
        sock.__hx_get_output()
            .write_string(hxrt::string::HxString::from("--"), None);
        sock.__hx_get_output()
    ...
    fn read_chunked(
        ...
        loop {
            ...
            if semi >= 0 {
                size_line = hxrt::string::HxString::from(hxrt::string::substr(
                    size_line.as_str(),
                    0,
                    Some(semi),
                ));
    ...
    fn __hx_dyn_default_on_data(_self_: &crate::HxRefCell<Http>, data: hxrt::string::HxString) {
        let _ = &data;
    }

    pub fn on_data(self_: &crate::HxRefCell<Http>, data: hxrt::string::HxString) {
    ...
    pub fn on_bytes(self_: &crate::HxRefCell<Http>, data: crate::HxRef<hxrt::bytes::Bytes>) {
        let __hx_dyn = self_.borrow().__hx_dyn_on_bytes.clone();
        __hx_dyn(data);
    }

    fn __hx_dyn_default_on_error(_self_: &crate::HxRefCell<Http>, msg: hxrt::string::HxString) {
        let _ = &msg;
    }

    pub fn on_error(self_: &crate::HxRefCell<Http>, msg: hxrt::string::HxString) {
        let __hx_dyn = self_.borrow().__hx_dyn_on_error.clone();
        __hx_dyn(msg);
    }

    fn __hx_dyn_default_on_status(_self_: &crate::HxRefCell<Http>, status: i32) {
        let _ = &status;
    }

    pub fn on_status(self_: &crate::HxRefCell<Http>, status: i32) {
        let __hx_dyn = self_.borrow().__hx_dyn_on_status.clone();
        __hx_dyn(status);
    }

    fn has_on_data(self_: &crate::HxRefCell<Http>) -> bool {
        let __hx_this: crate::HxRef<crate::sys_http::Http> = self_.self_ref();
        return !({
            let __hx_dyn_recv = __hx_this.clone();
            let __hx_dyn = __hx_dyn_recv.borrow().__hx_dyn_on_data.clone();
    ...
    fn success(self_: &crate::HxRefCell<Http>, data: crate::HxRef<hxrt::bytes::Bytes>) {
        ...
        if crate::sys_http::Http::has_on_data(&*__hx_this) {
            let s: hxrt::string::HxString =
                hxrt::string::HxString::from(crate::sys_http::Http::get_response_data(&*__hx_this));
            if !s.is_null() {
                crate::sys_http::Http::on_data(
                    &*__hx_this,
                    hxrt::string::HxString::from(s.clone()),
                );
            }
        }
        crate::sys_http::Http::on_bytes(&*__hx_this, data.clone());
    }
    ...
    fn parse_url(url: hxrt::string::HxString) -> crate::HxRef<hxrt::anon::Anon> {
        ...
        if hxrt::string::index_of(
            u.as_str(),
            hxrt::string::HxString::from("http://").as_str(),
            Some(0),
        ) == 0
        {
            u = hxrt::string::HxString::from(hxrt::string::substr(
                u.as_str(),
            ...
            if hxrt::string::index_of(
                u.as_str(),
                hxrt::string::HxString::from("https://").as_str(),
                Some(0),
            ) == 0
            {
                secure = true;
        ...
        if colon >= 0 {
            host = hxrt::string::HxString::from(hxrt::string::substr(
                host_port.as_str(),
                0,
                Some(colon),
            ));
            let parsed_port: i32 =
                crate::sys_http::Http::parse_dec_int(hxrt::string::HxString::from(
                    hxrt::string::substr(host_port.as_str(), colon + 1, None),
                ));
            if parsed_port < 0 {
                return {
                    let __o = crate::HxRef::new(hxrt::anon::Anon::new());
    ...
    fn parse_status(line: hxrt::string::HxString) -> i32 {
        ...
        let code_str: hxrt::string::HxString = hxrt::string::HxString::from(hxrt::string::substr(
            line.as_str(),
            first + 1,
            Some(second - first - 1),
        ));
