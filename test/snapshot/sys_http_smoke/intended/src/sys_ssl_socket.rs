...
pub struct Socket {
    ...
    pub custom: Option<hxrt::dynamic::Dynamic>,
    handle: crate::HxRef<hxrt::net::SocketHandle>,
    pub verify_cert: Option<bool>,
    ca: Option<crate::HxRef<crate::sys_ssl_certificate::Certificate>>,
    hostname: Option<String>,
    server_cert: Option<crate::HxRef<crate::sys_ssl_certificate::Certificate>>,
    server_key: Option<crate::HxRef<crate::sys_ssl_key::Key>>,
}

impl Socket {
    pub fn new() -> crate::HxRef<crate::sys_ssl_socket::Socket> {
        let self_: crate::HxRef<crate::sys_ssl_socket::Socket> =
            crate::HxRc::new(crate::HxRefCell::new(Socket {
                input: None,
                output: None,
                custom: None,
        ...
        };
        {
            ...
            self_.borrow_mut().input = Some(__tmp.clone());
            __tmp
        };
        {
            let __tmp = crate::sys_net_socket_output::SocketOutput::new(h.clone());
            self_.borrow_mut().output = Some(__tmp.clone());
            __tmp
        };
        return self_;
    }
    ...
    pub fn handshake(self_: &crate::HxRefCell<Socket>) {
        let verify: bool = self_.borrow().verify_cert.clone() != Some(false);
        if self_.borrow().server_cert.clone().is_some()
            && self_.borrow().server_key.clone().is_some()
        {
            {
                let cert_handle = self_
                    .borrow()
                    .server_cert
                    .clone()
                    .clone()
        ...
        {
            let ca_handle = match self_.borrow().ca.clone().clone() {
                None => None,
    ...
    pub fn set_ca(
        ...
        {
            let __tmp = cert;
            self_.borrow_mut().ca = Some(__tmp.clone());
            __tmp
        };
    }
    ...
    pub fn set_hostname(self_: &crate::HxRefCell<Socket>, name: String) {
        {
            let __tmp = name;
            self_.borrow_mut().hostname = Some(__tmp.clone());
            __tmp
        };
    }
    ...
    pub fn set_certificate(
        ...
        {
            let __tmp = cert;
            self_.borrow_mut().server_cert = Some(__tmp.clone());
            __tmp
        };
        {
            let __tmp = key;
            self_.borrow_mut().server_key = Some(__tmp.clone());
            __tmp
        };
    }
    ...
    pub fn add_sni_certificate(
        ...
        _cb_servername_match: crate::HxRc<dyn Fn(String) -> bool + Send + Sync>,
    ...
    pub fn peer_certificate(
        ...
        let h: crate::HxRef<hxrt::ssl::Certificate> = self_
            .borrow()
            .handle
            .clone()
            .borrow()
    ...
    pub fn accept(self_: &crate::HxRefCell<Socket>) -> crate::HxRef<crate::sys_ssl_socket::Socket> {
        let h: crate::HxRef<hxrt::net::SocketHandle> =
            self_.borrow().handle.clone().borrow_mut().accept();
        ...
        {
            let __tmp = crate::sys_net_socket_input::SocketInput::new(h.clone());
            s.borrow_mut().input = Some(__tmp.clone());
            __tmp
        };
        {
            let __tmp = crate::sys_net_socket_output::SocketOutput::new(h.clone());
            s.borrow_mut().output = Some(__tmp.clone());
            __tmp
        };
        return s;
    }
    ...
    pub fn host(self_: &crate::HxRefCell<Socket>) -> crate::HxRef<hxrt::anon::Anon> {
        let info: hxrt::array::Array<i32> = {
            let (ip, port) = self_.borrow().handle.clone().borrow().host();
            hxrt::array::Array::<i32>::from_vec(vec![ip, port])
        };
        let host: crate::HxRef<crate::sys_net_host::Host> =
            crate::sys_net_host::Host::new(String::from("127.0.0.1"));
    ...
    pub fn wait_for_read(self_: &crate::HxRefCell<Socket>) {
        {
            let _ = hxrt::net::socket_select(
                vec![self_.borrow().handle.clone().clone()],
                vec![],
                vec![],
                Some(-1.0),
            );
    ...
    fn __hx_super_sys_net_socket_connect(
        ...
        self_
            ...
            .clone()
            .borrow_mut()
            .connect(host.borrow().ip as i32, port as i32);
    }
}
...
impl crate::sys_net_socket::SocketTrait for crate::HxRefCell<Socket> {
    ...
    fn __hx_get_custom(&self) -> Option<hxrt::dynamic::Dynamic> {
        self.borrow().custom.clone()
    }
    fn __hx_set_custom(&self, v: Option<hxrt::dynamic::Dynamic>) {
