...
pub const __HX_TYPE_ID: u32 = 0x45aaab62u32;
...
impl SocketInput {
    pub fn new(
        handle: crate::HxRef<hxrt::net::SocketHandle>,
    ) -> crate::HxRef<crate::sys_net_socket_input::SocketInput> {
        let self_: crate::HxRef<crate::sys_net_socket_input::SocketInput> =
            crate::HxRc::new(crate::HxRefCell::new(SocketInput {
                big_endian: false,
                handle: handle,
            }));
        return self_;
    ...
    pub fn read_byte(self_: &crate::HxRefCell<SocketInput>) -> i32 {
        let b: crate::HxRef<hxrt::bytes::Bytes> =
            crate::HxRc::new(crate::HxRefCell::new(hxrt::bytes::Bytes::alloc(1 as usize)));
        let n: i32 = crate::sys_net_socket_input::SocketInput::read_bytes(&self_, b.clone(), 0, 1);
        if n == 0 {
    ...
    pub fn read_all(
        ...
        match hxrt::exception::catch_unwind(|| loop {
            let len: i32 = crate::sys_net_socket_input::SocketInput::read_bytes(
                &self_,
                buf.clone(),
                0,
                bufsize_2,
    ...
    pub fn read_full_bytes(
        ...
        while l > 0 {
            let k: i32 =
                crate::sys_net_socket_input::SocketInput::read_bytes(&self_, s.clone(), p, l);
            if k == 0 {
                hxrt::exception::throw(hxrt::dynamic::from(hxrt::io::Error::Blocked));
            }
            {
    ...
    pub fn read(
        ...
        let mut p: i32 = 0;
        while remaining > 0 {
            let k: i32 = crate::sys_net_socket_input::SocketInput::read_bytes(
                &self_,
                s.clone(),
                p,
                remaining,
    ...
    pub fn read_until(self_: &crate::HxRefCell<SocketInput>, end: i32) -> String {
        let buf: crate::HxRef<crate::haxe_io_bytes_buffer::BytesBuffer> =
            crate::haxe_io_bytes_buffer::BytesBuffer::new();
        loop {
            let last: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
            if last == end {
                break;
            }
    ...
    pub fn read_float(self_: &crate::HxRefCell<SocketInput>) -> f64 {
        return crate::haxe_io_fp_helper::FPHelper::i32_to_float(
            crate::sys_net_socket_input::SocketInput::read_int32(&self_),
        );
    }

    pub fn read_double(self_: &crate::HxRefCell<SocketInput>) -> f64 {
        let i1: i32 = crate::sys_net_socket_input::SocketInput::read_int32(&self_);
        let i2: i32 = crate::sys_net_socket_input::SocketInput::read_int32(&self_);
    ...
    pub fn read_int8(self_: &crate::HxRefCell<SocketInput>) -> i32 {
        let n: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        if n >= 128 {
            return n - 256;
        }
        return n;
    ...
    pub fn read_int16(self_: &crate::HxRefCell<SocketInput>) -> i32 {
        let ch1: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let ch2: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
    ...
    pub fn read_u_int16(self_: &crate::HxRefCell<SocketInput>) -> i32 {
        let ch1: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let ch2: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        return if self_.borrow().big_endian {
            ch1 << 8 | ch2
    ...
    pub fn read_int24(self_: &crate::HxRefCell<SocketInput>) -> i32 {
        let ch1: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let ch2: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let ch3: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let n: i32 = if self_.borrow().big_endian {
            ch1 << 16 | (ch2 << 8) | ch3
        } else {
            ch1 | (ch2 << 8) | (ch3 << 16)
    ...
    pub fn read_u_int24(self_: &crate::HxRefCell<SocketInput>) -> i32 {
        let ch1: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let ch2: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let ch3: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        return if self_.borrow().big_endian {
    ...
    pub fn read_int32(self_: &crate::HxRefCell<SocketInput>) -> i32 {
        let ch1: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let ch2: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let ch3: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        let ch4: i32 = crate::sys_net_socket_input::SocketInput::read_byte(&self_);
        return if self_.borrow().big_endian {
    ...
    pub fn read_string(
        ...
        crate::sys_net_socket_input::SocketInput::read_full_bytes(&self_, b.clone(), 0, len);
        return {
            let _ = encoding;
...
impl crate::haxe_io_input::InputTrait for crate::HxRefCell<SocketInput> {
    ...
    fn set_big_endian(&self, b: bool) -> bool {
        SocketInput::set_big_endian(self, b)
    }
    fn __hx_type_id(&self) -> u32 {
        crate::sys_net_socket_input::__HX_TYPE_ID
    }
}
