...
impl BytesOutput {
    pub fn new() -> crate::HxRef<crate::haxe_io_bytes_output::BytesOutput> {
        let self_: crate::HxRef<crate::haxe_io_bytes_output::BytesOutput> =
            crate::HxRc::new(crate::HxRefCell::new(BytesOutput {
                big_endian: false,
    ...
    pub fn get_length(self_: &crate::HxRefCell<BytesOutput>) -> i32 {
        return crate::haxe_io_bytes_buffer::BytesBuffer::get_length(&self_.borrow().b.clone());
    }

    pub fn write_byte(self_: &crate::HxRefCell<BytesOutput>, c: i32) {
        crate::haxe_io_bytes_buffer::BytesBuffer::add_byte(&self_.borrow().b.clone(), c);
    }
    ...
    pub fn get_bytes(self_: &crate::HxRefCell<BytesOutput>) -> crate::HxRef<hxrt::bytes::Bytes> {
        return crate::haxe_io_bytes_buffer::BytesBuffer::get_bytes(&self_.borrow().b.clone());
    }
    ...
    pub fn write(self_: &crate::HxRefCell<BytesOutput>, s: crate::HxRef<hxrt::bytes::Bytes>) {
        ...
        while l > 0 {
            let k: i32 =
                crate::haxe_io_bytes_output::BytesOutput::write_bytes(&self_, s.clone(), p, l);
            if k == 0 {
    ...
    pub fn write_double(self_: &crate::HxRefCell<BytesOutput>, x: f64) {
        ...
        if self_.borrow().big_endian {
            crate::haxe_io_bytes_output::BytesOutput::write_int32(&self_, i64.borrow().high);
            crate::haxe_io_bytes_output::BytesOutput::write_int32(&self_, i64.borrow().low);
        } else {
            crate::haxe_io_bytes_output::BytesOutput::write_int32(&self_, i64.borrow().low);
            crate::haxe_io_bytes_output::BytesOutput::write_int32(&self_, i64.borrow().high);
        }
    ...
    pub fn write_int8(self_: &crate::HxRefCell<BytesOutput>, x: i32) {
        ...
        crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x & 255);
    }
    ...
    pub fn write_int16(self_: &crate::HxRefCell<BytesOutput>, x: i32) {
        ...
        crate::haxe_io_bytes_output::BytesOutput::write_u_int16(&self_, x & 65535);
    }
    ...
    pub fn write_u_int16(self_: &crate::HxRefCell<BytesOutput>, x: i32) {
        ...
        if self_.borrow().big_endian {
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x >> 8);
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x & 255);
        } else {
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x & 255);
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x >> 8);
    ...
    pub fn write_int24(self_: &crate::HxRefCell<BytesOutput>, x: i32) {
        ...
        crate::haxe_io_bytes_output::BytesOutput::write_u_int24(&self_, x & 16777215);
    }
    ...
    pub fn write_u_int24(self_: &crate::HxRefCell<BytesOutput>, x: i32) {
        ...
        if self_.borrow().big_endian {
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x >> 16);
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x >> 8 & 255);
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x & 255);
        } else {
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x & 255);
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x >> 8 & 255);
    ...
    pub fn write_int32(self_: &crate::HxRefCell<BytesOutput>, x: i32) {
        if self_.borrow().big_endian {
            ...
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x >> 16 & 255);
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x >> 8 & 255);
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x & 255);
        } else {
            crate::haxe_io_bytes_output::BytesOutput::write_byte(&self_, x & 255);
