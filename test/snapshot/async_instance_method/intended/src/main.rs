...
fn main() {
    let worker: crate::HxRef<crate::worker::Worker> = crate::worker::Worker::new(41);
    let sum: i32 = hxrt::async_::block_on(crate::worker::Worker::plus(&*worker, 1));
    let bumped: i32 = hxrt::async_::block_on(crate::worker::Worker::bump_and_read(&*worker));
    crate::sys::Sys::println(hxrt::dynamic::from(format!(
        "{}{}",
        "sum=",
        hxrt::dynamic::from(sum).to_haxe_string()
    )));
    crate::sys::Sys::println(hxrt::dynamic::from(format!(
        "{}{}",
        "bump=",
        hxrt::dynamic::from(bumped).to_haxe_string()
    )));
    crate::sys::Sys::println(hxrt::dynamic::from(format!(
        "{}{}",
        "stored=",
