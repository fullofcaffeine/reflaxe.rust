...
mod optional_primitive_defaults;
mod string_buf;
mod string_tools;
mod sys;
mod sys_io_stderr;
...
fn main() {
    let defaults: crate::HxRef<crate::optional_primitive_defaults::OptionalPrimitiveDefaults> =
        crate::optional_primitive_defaults::OptionalPrimitiveDefaults::new(
            Some(false),
            Some(0),
            hxrt::string::HxString::from(""),
        );
    let explicit: crate::HxRef<crate::optional_primitive_defaults::OptionalPrimitiveDefaults> =
        crate::optional_primitive_defaults::OptionalPrimitiveDefaults::new(
            Some(true),
            Some(7),
            hxrt::string::HxString::from("fast"),
        );
    crate::sys::Sys::println(hxrt::dynamic::from(
        crate::optional_primitive_defaults::OptionalPrimitiveDefaults::describe(&*defaults),
    ));
    crate::sys::Sys::println(hxrt::dynamic::from(
        crate::optional_primitive_defaults::OptionalPrimitiveDefaults::describe(&*explicit),
    ));
}
