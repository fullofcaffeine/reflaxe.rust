...
fn take(
    items: hxrt::array::Array<crate::HxRef<crate::box_::Box>>,
) -> crate::HxRef<crate::box_::Box> {
    return {
        let __hx_opt = items.shift();
        match __hx_opt {
            Some(__v) => __v,
            None => crate::HxRef::null(),
        }
    };
}

fn main() {
    let items: hxrt::array::Array<crate::HxRef<crate::box_::Box>> =
        hxrt::array::Array::<crate::HxRef<crate::box_::Box>>::from_vec(vec![
            crate::box_::Box::new(hxrt::string::HxString::from("first")),
        ]);
    let first: crate::HxRef<crate::box_::Box> = take(items.clone());
    let second: crate::HxRef<crate::box_::Box> = take(items.clone());
    crate::sys::Sys::println(if first.is_null() {
        hxrt::dynamic::from(hxrt::string::HxString::from("null"))
    } else {
        hxrt::dynamic::from({
            let __b = first.borrow();
            __b.label.clone()
        })
    });
    crate::sys::Sys::println(if second.is_null() {
        hxrt::dynamic::from(hxrt::string::HxString::from("null"))
    } else {
        hxrt::dynamic::from({
            let __b = second.borrow();
            __b.label.clone()
        })
    });
}
