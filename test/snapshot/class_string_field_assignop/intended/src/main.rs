...
fn main() {
    let acc: crate::HxRef<crate::accumulator::Accumulator> = crate::accumulator::Accumulator::new();
    crate::sys::Sys::println(hxrt::dynamic::from(
        crate::accumulator::Accumulator::append(&*acc, hxrt::string::HxString::from("a")),
    ));
    crate::sys::Sys::println(hxrt::dynamic::from(
        crate::accumulator::Accumulator::append(&*acc, hxrt::string::HxString::from("-b")),
    ));
    crate::sys::Sys::println(hxrt::dynamic::from({
        let __b = acc.borrow();
        __b.text.clone()
