...
fn main() {
    crate::sys::Sys::println(hxrt::dynamic::from(hxrt::string::HxString::from(
        hxrt::path::directory(hxrt::string::HxString::from("alpha/beta/gamma.txt").as_str()),
    )));
    crate::sys::Sys::println(hxrt::dynamic::from(hxrt::string::HxString::from(
        hxrt::path::directory(hxrt::string::HxString::from("single.txt").as_str()),
    )));
    crate::sys::Sys::println(hxrt::dynamic::from(hxrt::string::HxString::from(
        hxrt::path::directory(hxrt::string::HxString::from("/root/file.txt").as_str()),
    )));
}
