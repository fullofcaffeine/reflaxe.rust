...
fn main() {
    let boxed: crate::HxRef<crate::bounded_box::BoundedBox<String>> =
        crate::bounded_box::BoundedBox::<String>::new(String::from("metal"));
    crate::sys::Sys::println(hxrt::dynamic::from(
        crate::bound_tools::BoundTools::describe(crate::bounded_box::BoundedBox::clone_value(
            &*boxed,
        )),
    ));
}
