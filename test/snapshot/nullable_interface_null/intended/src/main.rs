...
pub(crate) fn __hx_is_subtype_type_id(actual: u32, expected: u32) -> bool {
    ...
    match actual {
        0xc9f41c03u32 => matches!(expected, 0x57277b80u32),
...
fn main() {
    let missing: crate::HxDynRef<dyn crate::service::Service + Send + Sync> =
        crate::HxDynRef::<dyn crate::service::Service + Send + Sync>::null();
