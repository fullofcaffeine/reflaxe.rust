...
fn main() {
    let payload: crate::HxRef<crate::payload::Payload<hxrt::string::HxString>> =
        crate::helpers::Helpers::make(hxrt::string::HxString::from("ok"));
    crate::sys::Sys::println(hxrt::dynamic::from(crate::helpers::Helpers::read(
        payload.clone(),
    )));
}
