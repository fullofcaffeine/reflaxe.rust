...
class Exception {
	...
	private function get_message(): String return __message;

	public var stack(get, never): CallStack;
	private function get_stack(): CallStack return __stack;

	public var previous(get, never): Null<Exception>;
	private function get_previous(): Null<Exception> return __previous;
