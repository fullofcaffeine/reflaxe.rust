...
/**
	...
	What
	- Function identity (`functionName`) and async contract.
...
class RustFuncContext {
	...
	public function new(functionName:String, isAsync:Bool, mutatedArgs:Array<String>, localNamesCount:Int, localReadCountEntries:Int) {
