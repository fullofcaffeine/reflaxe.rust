...
- [Pre-1.0 compatibility review](pre-1.0-compatibility-review.md): stable-candidate, qualified, experimental, and excluded surfaces plus migration/toolchain blockers.
