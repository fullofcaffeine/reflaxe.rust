...
- Portable semantic-diff cases: `21`
...
- Scope: Null strings, typed/dynamic exceptions, class/interface subtype-aware catches, generic base/interface specialization, virtual dispatch, env vars, function-value parity, portable Option/Result
- Evidence:
