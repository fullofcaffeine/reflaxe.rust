...
| `haxe.iterators.*` | Portable contract | Tier1 + Tier2 sweeps, `test/semantic_diff/map_key_value_iterator_manual`, `test/semantic_diff/anonymous_key_value_aliasing` | Includes the Rust-side implementation of `MapKeyValueIterator`; iterator items preserve ordinary anonymous-record aliasing and identity. |
