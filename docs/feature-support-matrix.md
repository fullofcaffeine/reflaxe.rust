...
| --- | --- | --- | --- |
| `Std`, `StringTools`, `Math`, `Date` | `portable contract` | Tier1 + Tier2 sweeps, snapshots, semantic-diff, candidate audit | Core portable surface with the strongest current proof depth. |
