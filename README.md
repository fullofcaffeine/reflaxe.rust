...
[![Version](https://img.shields.io/badge/version-0.69.0-blue)](https://github.com/fullofcaffeine/reflaxe.rust/releases)
...
- Rust-native systems facades are growing beside portable `sys.*` APIs. Current slices include
  ...
  directory/environment set-remove-clear/cwd+env support; neither replaces portable `sys.io.File` /
  `sys.io.Process`.
